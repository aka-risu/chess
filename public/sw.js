...
const ENGINE = ["/stockfish/stockfish.js", "/stockfish/stockfish.wasm"];
const CORE = ["/", "/results", "/play", "/puzzles", "/openings", "/history", "/clock", "/icon.svg", "/manifest.webmanifest", ...PIECES, ...ENGINE];
